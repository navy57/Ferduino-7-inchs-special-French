  ...
  else
  {
    switch (dispScreen)
    {
      ...
      case 3:                    // -------------------Tela testar led------------------------------------------
        ...
        break;
      case 4:             //---------------------------------------Tela controle de temperatura--------tela =4-------------------
      ...
      case 5:         // -------------------------------- Tela alterar valores led ------------------------------------------------------------
        ...
        else if (checkButtons(leST[0], leST[1], leST[2]+20, leST[3]) == true)       // Alterar valores dos leds
        {
          dispScreen = 6;
          clearScreen();
          ledChangeScreen(true);
        }
        else if (checkButtons(savE[0]+20, savE[1], savE[2], savE[3]) == true)      // Salva os valores na EEPROM
        {
          SaveLEDToEEPROM();
          dispScreen = 28;
          clearScreen();
      ...
      case 7: //--------------------------------------------- configurar tpa autom.-----------------------------------
        if (checkButtons(houU[0], houU[1]-40, houU[2], houU[3]-40) == true)
        {
          temp2hora = (temp2hora + 1) % 24;
          tpaScreen();
        }
        else if (checkButtons(minUT[0], minUT[1]-40, minUT[2], minUT[3]-40) == true)
        {
        ...
        else if (checkButtons(houD[0], houD[1]-40, houD[2], houD[3]-40) == true)
        {
          temp2hora = (temp2hora + 23) % 24;
          tpaScreen();
        }
        else if (checkButtons(minDT[0], minDT[1]-40, minDT[2], minDT[3]-40) == true)
        {
      ...
      case 26: //------------------------------------ calibrar dosadoras -------------------------------------------
        if (checkButtons(almP[0], almP[1]-110, almP[2], almP[3]-110) == true)            //fator calibracao mais.
        {
        ...
        else if (checkButtons(almM[0], almM[1]-110, almM[2], almM[3]-110) == true)            //fator calibracao menos.
        {
          fator_calib_dosadora[dosadora_selecionada] -= 0.1;
      ...
      case 27:   // ----------------------------------------- Config dosagem manual --------------------------------------
        if (checkButtons(almP[0], almP[1]-100, almP[2], almP[3]-100) == true)            //dose manual mais.
        {
        ...
        else if (checkButtons(almM[0], almM[1]-100, almM[2], almM[3]-100) == true)            //dose manual menos.
        {
          dose_dosadora_manual[dosadora_selecionada] -= 0.5;
        ...
        break;
      case 28:  //--------------------------------Escolher canal LEDS-----------------------------------tela =28
        if (checkButtons(tempG[0], tempG[1]+60, tempG[2], tempG[3]+60) == true) // "BRANCO"
        {
          cor_selecionada = 0;
          dispScreen = 5;
          clearScreen();
        ...
        else if (checkButtons(phA[0]+320, phA[1]-40, phA[2]+320, phA[3]-40) == true) // "AZUL"
        {
          cor_selecionada = 1;
          dispScreen = 5;
          clearScreen();
        ...
        else if (checkButtons(phR[0]+170, phR[1]-20, phR[2]+170, phR[3]-20) == true) // "AZUL ROYAL"
        {
          cor_selecionada = 2;
          dispScreen = 5;
          clearScreen();
        ...
        else if (checkButtons(orP[0], orP[1], orP[2], orP[3]) == true) // "VERMELHO"
        {
          cor_selecionada = 3;
          dispScreen = 5;
          clearScreen();
        ...
        else if (checkButtons(denS[0], denS[1]+300, denS[2], denS[3]+300) == true) // "VIOLETA"
        {
          cor_selecionada = 4;
          dispScreen = 5;
          clearScreen();
      ...
      case 29:   // ----------------------------------------- Config dosagem personalizada --------------------------------------
        ...
        else if (checkButtons(houU[0], houU[1]-40, houU[2], houU[3]-40) == true)
        {
        ...
        else if (checkButtons(houU[0] + 310, houU[1]-40, houU[2] + 310, houU[3]-40) == true)
        {
          hora_final_dosagem_personalizada[dosadora_selecionada] = (hora_final_dosagem_personalizada[dosadora_selecionada] + 1) % 24;
          config_dosagem_personalizada();
        }
        else if (checkButtons(minUT[0] + 310, minUT[1]-40, minUT[2] + 310, minUT[3]-40) == true)
        {
        ...
        else if (checkButtons(houD[0] + 310, houD[1]-40, houD[2] + 310, houD[3]-40) == true)
        {
          hora_final_dosagem_personalizada[dosadora_selecionada] = (hora_final_dosagem_personalizada[dosadora_selecionada] + 23) % 24;
          config_dosagem_personalizada();
        }
        else if (checkButtons(minDT[0] + 310, minDT[1]-40, minDT[2] + 310, minDT[3]-40) == true)
        {
        ...
        else if (checkButtons(domI[0] - 40, domI[1], domI[2] + 40, domI[3]) == true)
        {
      ...
      case 36: // -------------------------------- Luz noturna --------------------------------------------
        ...
        else if (checkButtons(temM[0], temM[1]+20, temM[2], temM[3]+20) == true)                      //press densidade minus
        {
          tMaxI -= 1;
          drawFillRect(256, 137, 360, 169, 0, 0, 0);
          luz_noturna();
        }
        else if (checkButtons(almM[0], almM[1]-50, almM[2], almM[3]-50) == true)                        //press alarm minus
        {
          tMinI -= 1;
          drawFillRect(256, 337, 360, 369, 0, 0, 0);
          luz_noturna();
        }
        else if (checkButtons(temP[0], temP[1]+20, temP[2], temP[3]+20) == true)                      //press densidade plus
        {
          tMaxI += 1;
          drawFillRect(256, 137, 360, 169, 0, 0, 0);
          luz_noturna();
        }
        else if (checkButtons(almP[0], almP[1]-50, almP[2], almP[3]-50) == true)                           //press alarm plus
        {
          tMinI += 1;
          drawFillRect(256, 337, 360, 369, 0, 0, 0);
          luz_noturna();
      ...
      case 42://---------------------------------------- Configurar coolers ----------------------------
        ...
        else if (checkButtons(temM[0], temM[1]+20, temM[2], temM[3]+20) == true)                   // Temperatura para velocidade mínima -
        {
          HtempMin_temp -= 0.1;
#ifdef USE_FAHRENHEIT
          if (HtempMin_temp < 68)
...
#endif
//myGLCD.setColor(0, 255, 0);
//          myGLCD.fillRect(256, 80, 360, 112);
          configurar_coolers();
        }
        else if (checkButtons(almM[0], almM[1]-50, almM[2], almM[3]-50) == true)                       // Temperatura para velocidade máxima -
        {
          HtempMax_temp -= 0.1;
#ifdef USE_FAHRENHEIT
...
#endif
//          myGLCD.setColor(0, 255, 0);
//          myGLCD.fillRect(256, 280, 390, 312);
          configurar_coolers();
        }
        else if (checkButtons(temP[0], temP[1]+20, temP[2], temP[3]+20) == true)                      // Temperatura para velocidade mínima +
        {
          HtempMin_temp += 0.1;
#ifdef USE_FAHRENHEIT
          if (HtempMin_temp > 95)
  ...
  //        myGLCD.setColor(0, 255, 0);
   //       myGLCD.fillRect(256, 80, 360, 112);
        ...
        else if (checkButtons(almP[0], almP[1]-50, almP[2], almP[3]-50) == true)                           // Temperatura para velocidade máxima +
        {
          HtempMax_temp += 0.1;
#ifdef USE_FAHRENHEIT
...
#endif
  //        myGLCD.setColor(0, 255, 0);
  //        myGLCD.fillRect(256, 280, 360, 312);
          configurar_coolers();
        }
        else if (checkButtons(menU[0], menU[1], menU[2], menU[3]) == true)           // volta ao menu 1
        {
