...
// Comment the line below to disable year
//#define Anno    // Veja o ano atual na parte inferior da tela inicial
...
#define SMALL true
#define BIG true
extern uint8_t Retro8x16[];    // Declara que fontes vamos usar
extern uint8_t arial_bold[];     // Declara que fontes vamos usar
...
// Pin 0 e 1 reservados para a porta serial 0.
const byte alarmPin = 0;          // Pin che azione l'allarme
const byte desativarFanPin = 1;   // Pin che disattiva/attiva le ventole.
// Pin 2 riservato per INT dell'RFM12B.
// Pin 3, 4, 5, 6 e 7 riservati per il touch
// Pin 5 è anche il chip seleziona la scheda SD
const byte ledPinUV = 8;         // pin che collega i led viola
const byte ledPinBlue = 9;       // pin che collega i led blu
const byte ledPinWhite = 10;     // pin che collega i led bianchi
const byte ledPinRoyBlue = 11;   // pin che collega i led azzurri
const byte ledPinRed = 12;       // pin che collega i led rossi
const byte fanPin = 13;          // Pin che controlla la velocità della ventola del dissipatore
// pin 14 e 15 riservati per la porta seriale 3 che comunica con i "Stamps"
...
// pin 18 e 19 riservati per l'RTC (modulo tempo reale).
// pin 20 e 21 riservati per la comunicasione I2C del PCF8575 Pinos 20 e 21 reservados para comunicação I2C do PCF8575.
// pin dal 22 al 41 riservati per l'LCD.
const byte aquecedorPin = 42;   // Pin di collegamento del riscaldatore
const byte chillerPin = 43;     // Pin di collegamento del rafreddatore
const byte ledPinMoon = 44;     // Pin di collegamento per i led di luce notturna
const byte wavemaker1 = 45;     // Pin che controlla il wavemaker 1
const byte wavemaker2 = 46;     // pin che controlla il wavemaker 2
...
const byte ozonizadorPin = 47;  // Pin di collegamento all'ozonizzatore
const byte reatorPin = 48;      // Pin di collegamento al reattore di calcio
#endif // Do not change this line!
//***************************************************************************************************
//***************************************************************************************************

const byte sensoresPin = 49;    // Pin che legge i sensori di temperatura
// pin 50,51 e 52 riservati per la comunicazione SPI
// pin 53 riservato per "select slave" del shield ethernet
const byte sensor1 = 54;   // A0;      // pin analogico che controlla la tensione del galleggiante nel serbatoio di miscelazione dell'acqua salata
const byte sensor2 = 55;   // A1;      // pin analogico che controlla la tensione del galegggiante sul fondo della vasca di raccolta
const byte sensor3 = 56;   // A2;      // pin analogico che controlla la tensione del galegggiante in superficie della vasca di raccolta
const byte sensor4 = 57;   // A3;      // pin analogico che controlla la tensione del galeggiante del serbatoio
const byte sensor5 = 58;   // A4;      // pin analogico che controlla il livello della vasca di raccoltaa
const byte sensor6 = 59;   // A5;      // pin analogico che controlla il livello del serbatoio di rabbocco automatico
...
//***************************************************************************************************
#ifndef USE_PCF8575 // Do not change this line! 
const byte bomba1Pin = 60; // A6       // Pompa che attinge l'acqua dal serbatoio di miscelazione di acqua salata
const byte bomba2Pin = 61; // A7       // Pompa che preleva acqua dalla vasca di raccolta.
const byte bomba3Pin = 62; // A8       // Pompa che preleva acqua dal serbatoio di rabbocco alla vasca di raccolta
#endif // Do not change this line!
//***************************************************************************************************
//***************************************************************************************************

const byte dosadora1 = 63; // A9;      // pompa dosatrice 1
const byte dosadora2 = 64; // A10;     // pompa dosatrice 2
const byte dosadora3 = 65; // A11;     // pompa dosatrice 3
const byte dosadora4 = 66; // A12;     // pompa dosatrice 4
const byte dosadora5 = 67; // A13;     // pompa dosatrice 5
const byte dosadora6 = 68; // A14;     // pompa dosatrice 6
// Pin 69 (A15) riservato per SS dell'RFM12B
...
//***************************************************************************************************
#ifndef USE_PCF8575 // Do not change this line!
const byte temporizador1 = 80;           // Pin di collegamento del timer 1.
const byte temporizador2 = 81;           // Pin di collegamento del timer 2.
const byte temporizador3 = 82;           // Pin di collegamento del timer 3.
const byte temporizador4 = 83;           // Pin di collegamento del timer 4.
const byte temporizador5 = 84;           // Pin di collegamento del timer 5.
const byte solenoide1Pin = 85;           // Pin per attivare sistema RO/DI quando il serbatoio è basso.
const byte alimentadorPin = 86;          // Pin che controlla l'alimentatore automatico.
const byte skimmerPin = 87;              // Pin che controlla il skimmer
#endif // Do not change this line!
...
//****************************************************************************************************
OneWire OneWireBus(sensoresPin);        // sensore di temperatura
...
//*******************************************************************************************************
#ifdef USE_TFT // Do not change this line
UTFT        myGLCD(CTE50CPLD, 38, 39, 40, 41); // "ITDB32WD" é o modelo do LCD
